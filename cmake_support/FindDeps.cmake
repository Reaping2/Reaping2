...
function( my_find_package pkg_name header default_lib_name )
	if(WIN32)
		set( lib_names ${ARGN})
		...
		if(NOT ${${pkg_name}_FOUND} )
			set( ${pkg_name}_LIBRARY ${default_lib_name} PARENT_SCOPE )
			set( ${pkg_name}_INCLUDE_DIR "" PARENT_SCOPE )
			set( ${pkg_name}_INCLUDE_DIRS ${${pkg_name}_INCLUDE_DIR} PARENT_SCOPE )
			set( ${pkg_name}_LIBRARIES ${${pkg_name}_LIBRARY} PARENT_SCOPE )
		endif()
	endif(WIN32)
endfunction( my_find_package )

my_find_package( GLEW GL/glew.h GLEW glew32 glew glew32s )

my_find_package( GLFW GLFW/glfw3.h glfw3 glfw3dll )
...
message( "Portaudio CMAKE config dir: ${PORTAUDIO_CMAKE_INCLUDE_DIR}")