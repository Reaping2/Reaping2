#ifndef INCLUDED_ENGINE_MAX_HEALTH_BUFF_SUB_SYSTEM_H
#define INCLUDED_ENGINE_MAX_HEALTH_BUFF_SUB_SYSTEM_H
...
#endif//INCLUDED_ENGINE_MAX_HEALTH_BUFF_SUB_SYSTEM_H
