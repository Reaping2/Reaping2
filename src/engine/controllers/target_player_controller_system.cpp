...
TargetPlayerControllerSystem::TargetPlayerControllerSystem()
    : mScene( Scene::Get() )
{

}

void TargetPlayerControllerSystem::Init()
{


}

void TargetPlayerControllerSystem::Update(double DeltaTime)
{
