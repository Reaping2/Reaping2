#ifndef INCLUDED_MAP_PROPERTY_EDITOR_SYSTEM_H
#define INCLUDED_MAP_PROPERTY_EDITOR_SYSTEM_H
...
class PropertyEditorSystem : public engine::System
{
public:
    DEFINE_SYSTEM_BASE(PropertyEditorSystem)
...
#endif//INCLUDED_MAP_PROPERTY_EDITOR_SYSTEM_H
