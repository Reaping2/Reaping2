...
const uint32_t Collisions[] =
{
    ...
    1 << CollisionClass::Projectile | 1 << CollisionClass::AoeDamage | 1 << CollisionClass::Creep | 1 << CollisionClass::Player | 1 << CollisionClass::Wall | 1 << CollisionClass::Pickup | 1 << CollisionClass::Water | 1 << CollisionClass::Flag | 1 << CollisionClass::Activatable, // player
    ...
    1 << CollisionClass::Player, // activatable
};
